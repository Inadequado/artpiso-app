...
export const lotes: LoteEstoque[] = [
  {
    ...
    tamanho: '60x60',
    lote: 'L-2405',
    alocacoes: [{ quadra: 'Q-3 A', caixas: 40 }],
    bitola: '2',
    tonalidade: 'A3',
    m2PorCaixa: 2.16,
    pecasPorCaixa: 6,
  ...
  },
  {
    ...
    tamanho: '60x60',
    lote: 'L-2406',
    alocacoes: [{ quadra: 'Q-1 B', caixas: 18 }],
    bitola: '3',
    tonalidade: 'A4',
    m2PorCaixa: 2.16,
    pecasPorCaixa: 6,
  ...
  },
  {
    ...
    tamanho: '10x20',
    lote: 'L-2391',
    alocacoes: [{ quadra: 'Q-1 A', caixas: 12 }],
    m2PorCaixa: 0.9,
    pecasPorCaixa: 45,
    caixasEstoque: 12,
    caixasReserva: 6,
  ...
  },
  {
    ...
    alocacoes: [
      { quadra: 'Q-4 B', caixas: 30 },
      { quadra: 'Q-3 C', caixas: 15 },
    ],
    m2PorCaixa: 1.8,
    pecasPorCaixa: 8,
    caixasEstoque: 45,
  ...
  },
  {
    ...
    tamanho: '20x20',
    lote: 'L-2200',
    alocacoes: [{ quadra: 'Q-4 C', caixas: 12 }],
    bitola: '1',
    tonalidade: 'C2',
    m2PorCaixa: 1.2,
    pecasPorCaixa: 30,
  ...
  },
  {
    ...
    tamanho: '20x20',
    lote: 'L-2201',
    alocacoes: [{ quadra: 'Q-4 C', caixas: 40 }],
    m2PorCaixa: 1.2,
    pecasPorCaixa: 30,
    caixasEstoque: 40,
    caixasReserva: 8,
  ...
  },
  {
    ...
    tamanho: '80x80',
    lote: 'L-3010',
    alocacoes: [{ quadra: 'Q-4 A', caixas: 60 }],
    m2PorCaixa: 2.04,
    pecasPorCaixa: 3,
    caixasEstoque: 60,
    caixasReserva: 4,
  ...
  },
  {
    ...
    tamanho: '80x80',
    lote: 'L-3011',
    alocacoes: [{ quadra: 'Q-4 A', caixas: 25 }],
    m2PorCaixa: 2.04,
    pecasPorCaixa: 3,
    caixasEstoque: 25,
    caixasReserva: 0,
  ...
  },
  {
    ...
    tamanho: '20x90',
    lote: 'L-3020',
    alocacoes: [{ quadra: 'Q-2 B', caixas: 38 }],
    m2PorCaixa: 1.62,
    pecasPorCaixa: 9,
    caixasEstoque: 38,
    caixasReserva: 6,
  ...
  },
  {
    ...
    tamanho: '20x90',
    lote: 'L-3021',
    alocacoes: [{ quadra: 'Q-3 B', caixas: 14 }],
    m2PorCaixa: 1.62,
    pecasPorCaixa: 9,
    caixasEstoque: 14,
    caixasReserva: 0,
  ...
  },
  {
    ...
    tamanho: '30x60',
    lote: 'L-3030',
    alocacoes: [{ quadra: 'Q-2 A', caixas: 16 }],
    m2PorCaixa: 1.44,
    pecasPorCaixa: 8,
    caixasEstoque: 16,
    caixasReserva: 2,
  ...
  },
  {
    ...
    tamanho: '30x30',
    lote: 'L-3040',
    alocacoes: [{ quadra: 'Q-2 C', caixas: 25 }],
    m2PorCaixa: 0.9,
    pecasPorCaixa: 10,
    caixasEstoque: 25,
    caixasReserva: 3,
  ...
  },
  {
    ...
    tamanho: '19x120',
    lote: 'L-3050',
    alocacoes: [{ quadra: 'Q-1 C', caixas: 41 }],
    m2PorCaixa: 2.3,
    pecasPorCaixa: 10,
    caixasEstoque: 41,
    caixasReserva: 5,
...
// A identidade da quadra e o `numero` = "Q-<n> <deposito>" (ex.: "Q-1 B"), UNICO —
// e a chave que resolve a quadra em todo o app. `descricao` guarda o deposito
// "limpo" ("B"), usado pra ordenar/agrupar e editar. Q-00 e o balde sem deposito.
export const quadras: Quadra[] = [
  ...
  { id: 'q-a1', numero: 'Q-1 A', descricao: 'A', status: 'ocupado' },
  { id: 'q-a2', numero: 'Q-2 A', descricao: 'A' },
  { id: 'q-a3', numero: 'Q-3 A', descricao: 'A' },
  { id: 'q-a4', numero: 'Q-4 A', descricao: 'A' },
  { id: 'q-b1', numero: 'Q-1 B', descricao: 'B' },
  { id: 'q-b2', numero: 'Q-2 B', descricao: 'B' },
  { id: 'q-b3', numero: 'Q-3 B', descricao: 'B' },
  { id: 'q-b4', numero: 'Q-4 B', descricao: 'B' },
  { id: 'q-c1', numero: 'Q-1 C', descricao: 'C' },
  { id: 'q-c2', numero: 'Q-2 C', descricao: 'C' },
  { id: 'q-c3', numero: 'Q-3 C', descricao: 'C' },
